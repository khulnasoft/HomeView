<template>
  <modal
    ...
    width="50%"
    height="80%"
    classes="homeview-modal edit-app-config"
    @closed="modalClosed"
  >
  ...
  <div class="app-config-intro">
    ...
    <a href="https://homeview.to/docs/configuring#appconfig-optional">
...
import HomeviewSchema from '@/utils/ConfigSchema';
...
export default {
  ...
  data() {
    return {
      formData: {},
      schema: HomeviewSchema.properties.appConfig,
