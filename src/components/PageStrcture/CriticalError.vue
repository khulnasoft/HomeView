  ...
  <div class="critical-error-wrap" v-if="shouldShow">
    ...
    <ul>
      <li>Check the browser console for more details
        (<a href="https://github.com/KhulnaSoft/homeview/blob/master/docs/troubleshooting.md#how-to-open-browser-console">see how</a>)
      </li>
      <li>View the
        <a href="https://github.com/KhulnaSoft/homeview/blob/master/docs/troubleshooting.md">Troubleshooting Guide</a>
        and <a href="https://homeview.to/docs/">Docs</a>
      </li>
      <li>
        ...
        then <a href="https://github.com/KhulnaSoft/homeview/issues/new/choose">open a ticket on GitHub</a>
      </li>
